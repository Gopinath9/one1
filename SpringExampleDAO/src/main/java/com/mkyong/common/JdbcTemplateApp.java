...
public class JdbcTemplateApp 
{
    public static void main( String[] args )
    {
    	...
    	//it's better to create an unit test rather than testing like this :)
         ...
         Customer customer1 = new Customer(4, "java",22);
         //Customer customer2 = new Customer(2, "mkyong2",22);
         //Customer customer3 = new Customer(3, "mkyong3",23);
		 ...
		 */
         ...
         Customer customerA = customerDAO.findByCustomerId2(5);
         System.out.println("Customer A : " + customerA);
         
         List<Customer> customers = customerDAO.listCustomersRE();
