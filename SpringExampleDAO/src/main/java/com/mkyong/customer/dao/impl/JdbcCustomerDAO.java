...
import com.mkyong.customer.model.CustomerResultSetExtractor;
...
public class JdbcCustomerDAO extends JdbcDaoSupport implements CustomerDAO {
	...
	public void update(Customer customer) {
		...
		getJdbcTemplate().update(sql, new Object[] { customer.getName(), customer.getAge(), customer.getCustId() });
...
//fetching
	...
	public List<Customer> listCustomers() {
		...
		List<Customer> customers = getJdbcTemplate().query(sql, new Object[] {}, new CustomerRowMapper());
		return customers;

	}

	public Customer getCustomerRE(int custId) {

		String sql = "SELECT * FROM  CUSTOMER where  CUST_ID=?";
		List<Customer> customers = (List<Customer>) getJdbcTemplate().query(sql, new Object[] { custId },
				new CustomerResultSetExtractor());
		return (customers != null && !customers.isEmpty()) ? customers.get(0) : null;
	}

	public List<Customer> listCustomersRE() {

		String sql = "select * from customer";

		List<Customer> customers = (List<Customer>) getJdbcTemplate().query(sql, new Object[] {},
				new CustomerResultSetExtractor());
